...
public class Main {
    public static void main(String[] args) {
        ...
        else System.out.println("Если возраст человека равен " + ageForPlace + ", то ему пора уже работать\n");
        ...
        else System.out.println("Если возраст ребенка равен " + childAgeForAttraction + ", то ему можно без сопровождения взрослого\n");
        ...
        else System.out.println("В автобусе нет мест\n");
